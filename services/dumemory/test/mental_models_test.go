...
func TestMentalModelsLifecycle(t *testing.T) {
	...
	t.Run("CreateMentalModel", func(t *testing.T) {
		req := dumemory.NewCreateMentalModelRequest(testMentalModelName, "what do you remember?")
	...
	t.Run("ListMentalModels", func(t *testing.T) {
		out, err := c.ListMentalModels(ctx(t), bankID(), dumemory.ListMentalModelsOptions{Limit: 10})
		if err != nil {
